...
import { checkData } from "./lib/check.js";
...
bot.onText(/\/today/, async (msg) => {
  ...
  try {
    ...
    if (data) {
      ...
      bot.sendMessage(chatId, "На сьогодні пари відсутні");
    }
  } catch (error) {
    console.log(error);
  }
...
bot.onText(/\/tomorrow/, async (msg) => {
  ...
  try {
    ...
    if (data) {
      ...
      bot.sendMessage(chatId, "На завтра пари відсутні");
    }
...
bot.onText(/\/current/, async (msg) => {
  ...
  try {
    ...
    if (data) {
      ...
      bot.sendMessage(chatId, "Зараз пара відсутня");
    }
  } catch (error) {
    console.log(error);
  }
...
bot.onText(/\/next/, async (msg) => {
  ...
  try {
    ...
    if (data) {
      ...
      bot.sendMessage(chatId, "Відсутна наступна пара");
    }
  } catch (error) {
    console.log(error);
  }
